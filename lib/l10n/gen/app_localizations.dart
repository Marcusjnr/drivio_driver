...
abstract class AppLocalizations {
  ...
  /// App bar title of the Help & support page
  ///
  /// In en, this message translates to:
  /// **'Help & support'**
  String get helpTitle;

  /// Small uppercase eyebrow label above the help headline
  ///
  /// In en, this message translates to:
  /// **'SUPPORT'**
  String get helpEyebrow;

  /// Display headline of the Help & support page
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Drivio driver support'**
  String get helpSupportLineTitle;
  ...
  /// Message prefilled into the WhatsApp chat composer
  ///
  /// In en, this message translates to:
  /// **'Hello Drivio, I\'m a driver and I need some help.'**
  String get helpPrefillMessage;

  /// Toast shown when neither the WhatsApp app nor the wa.me link could be opened
  ///
  /// In en, this message translates to:
